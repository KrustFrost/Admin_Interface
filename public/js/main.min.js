...
var FullCalendar = function (e) {
  ...
  var Ui = function Ui(e) {
    ...
    return e.prototype.addSegs = function (e) {
      ...
      var i = 0,
          a = [];
      return e.spanStart < t.spanStart && (i += this.insertEntry(_r2(_r2({}, e), {
        spanStart: e.spanStart,
        spanEnd: t.spanStart
      }), a)), t.spanEnd < e.spanEnd && (i += this.insertEntry(_r2(_r2({}, e), {
        spanStart: t.spanEnd,
        spanEnd: e.spanEnd
      }), a)), i ? (n.push.apply(n, o([_r2(_r2({}, e), {
  ...
  var Ji = function (e) {
    ...
    return n(t, e), t.prototype.render = function () {
      ...
      }, this.renderView(t), this.buildAppendContent()), n.footerToolbar && mo(Qi, _r2({
        ref: this.footerRef,
  ...
  var ga = function () {
    function e(e, t) {
      for (var n = e.start, r = e.end, o = [], i = [], a = -1; n < r;) {
        t.isHiddenDay(n) ? o.push(a + .5) : (a += 1, o.push(a), i.push(n)), n = Ke(n, 1);
      }
  ...
  function Ra(e, t, n, r, o) {
    return "businessHours" === e ? _a(wt(r, t, o)) : "string" == typeof e ? _a(En(n, function (t) {
      return t.groupId === e;
    })) : "object" == _typeof(e) && e ? _a(wt(e, t, o)) : [];
  }
        ...
        if (o.isDragging) {
          ...
          if (o.clearDrag(), t.emitter.trigger("eventDragStop", {
            ...
            if (a === t) {
              ...
              }), a.emitter.trigger("drop", _r2(_r2({}, ks(f.dateSpan, a)), {
                draggedEl: e.subjectEl,
                jsEvent: e.origEvent,
  ...
  var Ns = function () {
    ...
    function e(e, t) {
      ...
      this.receivingContext = null, this.droppableEvent = null, this.suppliedDragMeta = null, this.dragMeta = null, this.handleDragStart = function (e) {
        ...
        if (n.clearDrag(), o && i) {
          ...
          if (o.emitter.trigger("drop", _r2(_r2({}, ks(a.dateSpan, o)), {
            draggedEl: e.subjectEl,
            jsEvent: e.origEvent,
            view: s
          })), l.create) {
    ...
    return e.prototype.buildDragMeta = function (e) {
      return "object" == _typeof(this.suppliedDragMeta) ? $i(this.suppliedDragMeta) : "function" == typeof this.suppliedDragMeta ? $i(this.suppliedDragMeta(e)) : $i((t = function (e, t) {
    ...
    var i,
      ...
      var t = e.entriesByLevel,
        ...
        var a = xl(function (e, t, n) {
          ...
          for (; l < s; l += 1) {
            for (var u = o[l], c = void 0, d = Bi(u, i.spanStart, Wi), p = d[0] + d[1], f = p; (c = u[f]) && c.spanStart < i.spanEnd;) {
              f += 1;
            }
  ...
  var Nl = nn({
    ...
    return n(t, e), t.prototype.render = function () {
      ...
      return this.props.isShort && e.push("fc-timegrid-event-short"), mo(qa, _r2({}, this.props, {
    ...
    return n(t, e), t.prototype.render = function () {
      ...
      return mo(So, null, this.renderHiddenGroups(E, e), y.map(function (s) {
        var l = e[s.segInput.index],
            ...
            d = _r2(_r2({}, a.computeSegTopBottomCss(s.segInput)), v ? {
          left: 0,
          right: 0
