...
/***/ "./resources/js/evo-calendar.min.js":
/*!******************************************!*\
  !*** ./resources/js/evo-calendar.min.js ***!
  \******************************************/
...
!function (e) {
  ...
  (t = function () {
    ...
    return function (a, n) {
      ...
      }, null != i.options.calendarEvents) for (var o = 0; o < i.options.calendarEvents.length; o++) {
        i.options.calendarEvents[o].id || console.log('%c Event named: "' + i.options.calendarEvents[o].name + "\" doesn't have a unique ID ", "color:white;font-weight:bold;background-color:#e21d1d;"), i.isValidDate(i.options.calendarEvents[o].date) && (i.options.calendarEvents[o].date = i.formatDate(i.options.calendarEvents[o].date, i.options.format));
      }
    ...
    for (var a = this, n = 0, i = 0; i < a.options.calendarEvents.length; i++) {
      if (a.options.calendarEvents[i].date instanceof Array) for (var o = a.getBetweenDates(a.options.calendarEvents[i].date), r = 0; r < o.length; r++) {
    ...
    if (i.children().length > 0 && i.empty(), t.options.calendarEvents) for (var o = 0; o < t.options.calendarEvents.length; o++) {
      if (t.isBetweenDates(t.$active.date, t.options.calendarEvents[o].date)) r(t.options.calendarEvents[o]);else if (t.options.calendarEvents[o].everyYear) {
    ...
    if (i instanceof Array) {
      if (e.everyYear) for (var r = 0; r < i.length; r++) {
    ...
    if (a instanceof Array) for (var i = t.getBetweenDates(a), o = 0; o < i.length; o++) {
      r(i[o]);
    } else r(a);
    ...
    function a(e) {
      if (e.id || console.log('%c Event named: "' + e.name + "\" doesn't have a unique ID ", "color:white;font-weight:bold;background-color:#e21d1d;"), e.date instanceof Array) for (var a = 0; a < e.date.length; a++) {
    ...
    for (e = 0; e < r; e++) {
      if ("object" == _typeof(i) || void 0 === i ? n[e].evoCalendar = new t(n[e], i) : a = n[e].evoCalendar[i].apply(n[e].evoCalendar, o), void 0 !== a) return a;
    }
...
/* harmony import */ var _evo_calendar_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! .//evo-calendar.min.js */ "./resources/js/evo-calendar.min.js");
/* harmony import */ var _evo_calendar_min_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_evo_calendar_min_js__WEBPACK_IMPORTED_MODULE_0__);
