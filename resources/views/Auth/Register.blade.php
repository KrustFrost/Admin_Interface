...
<div class="mt-20">
<p class="font-serif text-6xl p-10 font-mono flex justify-center break-word">Register here</p>
<div class="flex justify-center">
        ...
        <input type="text" placeholder="Name" name="name" class="p-3 shadow-md"/>
                    ...
                    <div class="flex justify-center">
                    <button type="submit" name="submit" class="bg-black text-white w-1/5 p-2 mt-2 mb-2 rounded-lg shadow-md">Register</button>
                    </div>
                    </form>
                </div>
            </div>
